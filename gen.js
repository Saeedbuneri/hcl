...
const tests = [
    {
        ...
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, we provide accurate Blood Sugar testing crucial for diabetes management and diagnosis.',
    ...
    },
    {
        ...
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, our Liver Function Tests help determine the health of your liver by measuring the levels of proteins, liver enzymes, and bilirubin in your blood.',
        q1: 'What is an LFT?',
    ...
    },
    {
        ...
        fasting: 'Not required',
        sample: 'Urine',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, our Urine Routine analysis provides a fast and reliable snapshot of your urinary tract health and kidney function.',
    ...
    },
    {
        ...
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, our Lipid Profile helps you understand your cardiovascular risk by measuring different types of fats in your blood.',
    ...
    },
    {
        ...
        fasting: 'Not required',
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, our Renal Function Tests accurately measure how efficiently your kidneys are clearing waste from your body.',
        q1: 'What is an RFT?',
    ...
    },
    {
        ...
        fasting: 'Not required',
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, our Thyroid Profile accurately assesses your thyroid gland function to help diagnose metabolism and energy-related disorders.',
    ...
    },
    {
        ...
        fasting: 'Not required',
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, we provide highly sensitive and confidential Viral Marker testing to rapidly detect infectious diseases.',
    ...
    },
    {
        ...
        fasting: 'Not required',
        sample: 'Blood',
        intro: 'At <strong>Healthcare Clinical Laboratory - Jowar, Buner</strong>, our Widal Test provides a quick and accurate diagnosis for enteric fevers like Typhoid.',
...
tests.forEach(test => {
    let newContent = template
        .replace(/<title>.*?<\/title>/, `<title>${test.headTitle} - Healthcare Clinical Laboratory - Jowar, Buner</title>`)
        ...
        .replace(/At <strong>Healthcare Clinical Laboratory - Jowar, Buner<\/strong>, we offer highly accurate and rapid blood testing services.*?<\/p>/, test.intro + '</p>')
